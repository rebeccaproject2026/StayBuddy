...
export default function PropertyDetailsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      `}</style>
      <a
        href={`https://wa.me/?text=${encodeURIComponent(`Check out this property: ${property?.title} - ${typeof window !== 'undefined' ? window.location.href : ''}`)}`}
        target="_blank"
        rel="noopener noreferrer"
        className="wa-float fixed bottom-6 right-6 z-50 w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:shadow-xl hover:bg-[#1ebe5d] transition-colors duration-300"
