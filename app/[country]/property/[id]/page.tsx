    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3 group/wa">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="wa-float w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:shadow-xl hover:bg-[#1ebe5d] transition-colors duration-300"
