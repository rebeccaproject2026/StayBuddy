...
export function getPostPropertyContent(userName: string) {
  ...
  return {
    en: {
      ...
      nearbyPlacesPlaceholder: "e.g. Metro Station, School, Hospital",
      nearbyPlacesHelper: "Type a place and press Enter or click Add",
    ...
    fr: {
      ...
      nearbyPlacesPlaceholder: "ex. Station de métro, École, Hôpital",
      nearbyPlacesHelper: "Tapez un lieu et appuyez sur Entrée ou cliquez sur Ajouter",
      ...
      fiftyTo100: "50-100",
      moreThan100: ">100",
      bhk: "BHK (Chambres, Salon, Cuisine)",
      oneBHK: "1 BHK",
      twoBHK: "2 BHK",
      threeBHK: "3 BHK",
      fourBHK: "4 BHK",
